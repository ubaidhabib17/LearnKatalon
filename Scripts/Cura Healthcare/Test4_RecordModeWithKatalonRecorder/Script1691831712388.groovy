...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'ini test dilakukan dengan katalon recorder di primary browser')
